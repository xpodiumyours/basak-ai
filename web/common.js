// common.js — anonim kimlik + sağlık bilgisi.
// Halka açık web'de kayıt/giriş yoktur. İlk ziyarette sunucu rastgele bir
// Başak ID üretir; kimliği doğrulayan imzalı HttpOnly çerez JavaScript'e açılmaz.
...
async function kimlikHazirla(zorla = false) {
  ...
  try { return await kimlikPromise; }
  catch (e) { kimlikPromise = null; throw e; }
}
